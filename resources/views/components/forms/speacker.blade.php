<template id="form1">
    <div
        class="circle-gr py-6 md:py-10 mt-4 h-[95vh] relative max-w-[488px] mx-auto bg-linear-(--violet4-gr) p-[2px] rounded-[32px] backdrop-blur-lg before:bg-linear-(--violet4-gr) before:p-1 before:rounded-[30px] before:-z-10 after:-z-10">
        <div class="w-full h-full">
            <form
                data-name="Форма 'Стать спикером'"
                data-form="form1"
                ...
                <div
                    class="circle-gr relative rounded-full before:bg-linear-(--violet-gr) before:p-[1px] before:rounded-[30px] before:-z-10 after:-z-10">
                    <input type="text" placeholder="Предпочтительный способ связи" name="contact_method"
